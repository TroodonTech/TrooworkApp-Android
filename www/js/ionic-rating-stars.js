        ...
        .directive("ratingStars", ["$parse", "$timeout", "$document", function ($parse, $timeout, $document) {
            return {
                ...
                template: function (el, attr) {
                    ...
                    var dataTemplate;
                    dataTemplate ='<div class="text-center ratingStars">';
                    dataTemplate += '<span ng-repeat="i in ' + max + ' | rangeionicstars">';
                    dataTemplate += '<i class="ion-ios-star-outline" style="font-size:40px;color: rgb(200, 200, 100);" id="rating_star_{{ i +1 }}" val="{{ i +1 }}" />';
                    dataTemplate += '</span></div>';
                    return dataTemplate;
                },
                require: 'ngModel',
