myApp.controller('tradeViewCtrl', function (HOSTNAME, $ionicPopup, $ionicPlatform, ionicDatePicker, $ionicLoading, $scope, $stateParams, $filter, $window, $ionicScrollDelegate, $state, $timeout, $http, $rootScope) {
    ...
    $ionicPlatform.ready(function () {
        ...
        $scope.myPromise = $http.get(HOSTNAME + "/getTradeRequestDetails_mob?OrganizationID=" + $scope.OrganizationID + "&employeekey=" + $scope.toServeremployeekey)
            .success(function (response) {
                $scope.viewtrade = response;
